...
COPY --from=builder /builder/gnat/target/release/gnat_hbos_model /opt/gnat/bin/gnat_hbos_model
COPY --from=builder /builder/gnat/target/release/gnat_iforest_model /opt/gnat/bin/gnat_iforest_model
